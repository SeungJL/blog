...
title: Node 20, Next 14에서 멈춘 프로젝트를 어디까지 올렸나
excerpt: Node는 24로, Next는 15로 올렸다. React 19는 함께 손봐야 할 파일이 너무 많아 이번엔 두고 왔다.
category: 기술
tags:
  - Next.js
  - Node.js
...
이 숫자들은 저장소의 `CLAUDE.md`에 적어뒀다. 다음에 여기 오는 사람이 — 그게 나여도 — 같은 걸 다시 조사하지 않도록.
