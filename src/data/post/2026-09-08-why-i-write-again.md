...
title: 2년 6개월 만에 다시 글을 쓰는 이유
excerpt: 매일 무언가를 내보내는 시간이었다. 만든 것을 돌아볼 자리는 따로 두지 않았다.
category: 회고
tags:
  - 회고
---

마지막 글을 쓴 게 2년 6개월 전이다. 그만 쓰기로 결정한 적은 없다. 만드는 일에 시간을 다 쓰면서 자연스럽게 그렇게 됐다.
...
그런데 정리를 하다 보니 걸리는 게 있었다. 왜 그 선택이 맞았는지 말로는 설명할 수 있는데, 남겨둔 적이 없었다. 겪은 건 많고 꺼내 쓸 수 있는 건 적었다.
...
만든 기능은 그날 바로 멤버들이 썼다. 나도 같은 스터디에 나갔으니 쓰는 걸 옆에서 봤고, 불편한 점을 그 자리에서 들었다. 듣고 고쳐서 다음 모임에 다시 내놨다. 만든 사람과 쓰는 사람 사이에 어떠한 벽도 없었다.

나는 나를 프론트엔드 개발자보다 프로덕트 엔지니어로 소개하고 싶다. 문제를 파악하고, 해결하고, 쓰는 사람에게 가치가 닿게 하는 일. 내가 개발을 하는 이유가 계속 거기에 있었다.

## 만들다 보니 정리하는 일이 좋아졌다

문제를 없애려고 시작했는데, 하다 보니 만드는 일 자체가 재미있어졌다.

몰랐던 걸 알게 되면 왜 그렇게 동작하는지 파고들었고, 파고든 걸 정리해서 글로 썼다. 처음 기술 블로그를 시작한 이유가 그거였다. 누구에게 보여주려던 게 아니라, 정리하면서 이해가 한 겹 더 생기는 감각이 좋았다.
...
서비스가 커지면서 해야 하는 일의 범위도 계속 넓어졌다.
...
쓰는 일보다 만드는 일이 먼저였다. 그때는 그게 맞았다. 그 기간에 만든 것들이 서비스를 여기까지 끌고 왔다.

## 만드는 일이 쉬워진 시대에

그 2년 6개월은 개발이라는 일이 크게 바뀐 시기이기도 했다. 이제 코드를 써본 적 없는 사람도 개발을 한다.

하지만 값이 떨어진 건 구현 속도다. 판단이 아니다.

AI는 묻는 것에 답한다. 무엇을 물어야 하는지는 알려주지 않는다. 지금 어떤 문제를 풀어야 하는지, 뭘 먼저 확인해야 하는지, 돌아온 답이 이 맥락에 맞는지. 큰 그림을 그리고 방향을 잡는 일은 여전히 사람 몫이다.

생각해보면 나는 처음부터 코드가 목적이 아니었다. 없애고 싶은 한 시간이 먼저 있었고, 코드는 수단이었다. 그래서 수단이 쉬워진 건 나에게 위협이 아니다.

그 판단을 만드는 재료는 결국 실무에서 쌓인 경험이다. 나는 그 재료를 이미 가지고 있다.
